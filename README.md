...
* **Source code**: https://github.com/fortify/fortify-ssc-parser-clair-rest
* **Automated builds**: https://github.com/fortify/fortify-ssc-parser-clair-rest/actions
...
* **Alternatives**:
	* SSC Parser Plugin for Yair (Clair client): https://github.com/fortify/fortify-ssc-parser-clair-yair
...
The software is provided "as is" and is not supported through the regular OpenText Support channels. Support requests may be submitted through the [GitHub Issues](https://github.com/fortify/fortify-ssc-parser-clair-rest/issues) page for this repository. A (free) GitHub account is required to submit new issues or to comment on existing issues. 
